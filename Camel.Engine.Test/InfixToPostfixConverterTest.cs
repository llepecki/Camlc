...
namespace Lepecki.Playground.Camel.Engine.Test
{
    ...
    public class InfixToPostfixConverterTest
    {
        ...
        public IReadOnlyCollection<string> ConvertShouldReturnCollectionOfSymbolsWithoutParenthesisInPostfixNotationOrder(string semicolonSeparatedSymbols)
        {
            string[] symbols = semicolonSeparatedSymbols.Split(';');
            ...
            return converter.Convert(symbols).Select(tokenDescriptor => tokenDescriptor.ToString()).ToArray();
        }
    }
}

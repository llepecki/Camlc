...
namespace Lepecki.Playground.ReversePolishNotationWebCalc.Engine.Test
{
    ...
    {
        [TestCase("3 mul 4 div 2", ExpectedResult = 6.0000, TestOf = typeof(RpnCalc))]
        [TestCase("3 add 4.2 mul 5.5 div 6", ExpectedResult = 6.8500, TestOf = typeof(RpnCalc))]
        [TestCase("(300 add 23.05) mul (43.3 sub 21) div (84 add 7)", ExpectedResult = 79.1650, TestOf = typeof(RpnCalc))]
        [TestCase("(4000.03 add 8) mul (6.5 sub 5) div ((3 sub 2) mul (4 add 2))", ExpectedResult = 1002.0075, TestOf = typeof(RpnCalc))]
